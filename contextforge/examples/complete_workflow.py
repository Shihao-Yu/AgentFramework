...
Environment Variables:
    FRAMEWORK_DB_URL: PostgreSQL connection string (asyncpg driver)
...
async def run_workflow(framework_db_url: Optional[str] = None) -> None:
    """
    Run the complete ContextForge workflow demonstration.
    
    Args:
        framework_db_url: Optional database URL override. If not provided,
                      uses FRAMEWORK_DB_URL environment variable.
    """
